...
const Modal = (props) => {
  ...
  const [isChoseSize, setIsChoseSize] = useState(false);
                ...
                <div className="p-t-33">
                  ...
                  <div className="flex-w flex-r-m p-b-10">
                    <div className="size-204 flex-w flex-m respon6-next">
                        ...
                        onClick={() => {
                          if (isChoseSize) {
                            cartContext.addToCart({
                              ...
                              price: product?.price,
                              amount: valueProduct,
                              totalPrice: product?.price * valueProduct,
                            });
                            setIsalert(true);
                            setTimeout(() => {
                              setIsalert(false);
                      ...
                      {isalert ? (
                        <Alert variant="success">Success Add To Cart !!!</Alert>
                      ) : null}
                      {!isChoseSize ? (
                        <Alert variant="danger">
                          Please Chose Your Size !!!
                        </Alert>
                      ) : null}
                    </div>
                  </div>
